 ...
 * these accumulate unbounded and exhaust the heap (ContainerNursery OOM,
 * UrlProtocol #294: tens of thousands of pending TotalTimeoutHandler tasks pinning
 * closed MuxChannel + Negotiator$ResponderHandler pipelines, while admission
 * control kept the live-substream count bounded).
 *
